...
SENT_USAGE=mSum             # qwOnly, depOnly, mFC, [*mSum], mMax, mWsum
...
SUB2=${DATA_PREF}__${FULL_OPTM_METHOD}__${DS_NAME}__ds${DEP_SIMULATE}__drop${DROP_RATE}
SUB3=${NEG_REPR}__${RM_SUB}__b${BATCH}__fbp${FBP_REPR}

OUTPUT_DIR=runnings/${DATA_NAME}/${SUB1}/${SUB2}/${SUB3}
mkdir -p ${OUTPUT_DIR}
cp train_compq.sh ${OUTPUT_DIR}/exec.sh
