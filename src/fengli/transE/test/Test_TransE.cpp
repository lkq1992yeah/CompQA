...
void prepare()
{
    FILE* f1 = fopen("../data/new_transfered_freebase-FB2M/entity2id_forTest.txt","r");
	FILE* f2 = fopen("../data/new_transfered_freebase-FB2M/relation2id_forTest.txt","r");
	int x;
    ...
    fclose(f_kb);
    FILE* f_kb1 = fopen("../data/new_transfered_freebase-FB2M/train.txt","r");
